...
mainRouter.get('/', authHelpers.loginRequired, mainController.index);
mainRouter.post('/', authHelpers.loginRequired, mainController.create1);
mainRouter.post('/', authHelpers.loginRequired, mainController.create2);
